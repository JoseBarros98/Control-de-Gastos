...
<body>
 ...
 <ul>
   ...
   <a href="/ingresos/create"><input class='animated' type='submit' value='Añadir Ingreso' ></a>
 </ul>
</div>
...
<div id="main-container">
 <table>
    <thead>
      <tr>
          <th>ID</th><th>Nombre</th><th>Descripcion</th><th>Fecha</th><th>Total</th>
      </tr>
    </thead>
    @foreach ($ingresos as $ingresos)
            <tr>
            <td scope="row">{{$ingresos->id}}</td>
                <td>{{$ingresos->nombrei}}</td>
